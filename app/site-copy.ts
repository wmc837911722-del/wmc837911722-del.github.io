...
export const siteCopy = {
  zh: {
    ...
    partners: {
      ...
      labelLocal: "合作品牌",
      kicker: "SELECTED COLLABORATION BRANDS",
      title: ["合作建立在交付，", "也建立在信任边界。"],
      intro:
        "以下滚动展示经本人确认并授权公开的部分合作品牌。当前并未完整展示全部合作记录；未展示的合作品牌、客户名称、项目资料与业务数据因保密约定不公开。",
      aria: "经本人确认并授权公开的部分合作品牌",
      pauseMotion: "暂停品牌滚动",
      ribbons: [
        {
          id: "collaboration-row-01",
          src: "/brands/partner-ribbons/banner1.webp",
          alt: "合作品牌 Logo：中检鉴定、belling、海丽达教育、广东交通集团、万科、南京大牌档、美心西饼、安宏基、石湾牌、MPE BEDDING",
          width: 5132,
          height: 168,
        },
        {
          id: "collaboration-row-02",
          src: "/brands/partner-ribbons/banner2.webp",
          alt: "合作品牌 Logo：物银中国、ToyCity、中国工商银行、柏瑞康、顺丰速运、橙益用车、金蝶精斗云、绘王、澳康达、健康洪梅",
          width: 5132,
          height: 168,
        },
        {
          id: "collaboration-row-03",
          src: "/brands/partner-ribbons/banner3.webp",
          alt: "合作品牌 Logo：哈文教育、杰科、美心、金地地产、周大福、华润置地、富印集团、北京大学临床研究所、博雅生命、有黔辣",
          width: 5132,
          height: 168,
        },
      ],
  ...
  en: {
    ...
    partners: {
      ...
      intro: "The moving wall shows selected collaboration brands personally confirmed and authorized for public display. This is not a complete record: undisclosed collaboration brands, client names, project materials and business data remain confidential.",
      aria: "Selected collaboration brands personally confirmed and authorized for public display",
      pauseMotion: "Pause brand wall",
      ribbons: [
        {
          id: "collaboration-row-01",
          src: "/brands/partner-ribbons/banner1.webp",
          alt: "Collaboration brand logos: CIC, belling, Hyledar, Guangdong Provincial Communications Group, Vanke, Nanjing Impressions, Maxim's Cakes, AHOKE, SHI WAN PAI and MPE BEDDING",
          width: 5132,
          height: 168,
        },
        {
          id: "collaboration-row-02",
          src: "/brands/partner-ribbons/banner2.webp",
          alt: "Collaboration brand logos: monobank, ToyCity, ICBC, PROCARE, SF Express, Chengyi Car Service, Kingdee Jingdouyun, HUION, AKD and Healthy Hongmei",
          width: 5132,
          height: 168,
        },
        {
          id: "collaboration-row-03",
          src: "/brands/partner-ribbons/banner3.webp",
          alt: "Collaboration brand logos: Hawen Education, GIEC, Mei-Xin, Gemdale, Chow Tai Fook, CR Land, Fuyin Group, PUCRI, Boyalife and Youqianla",
          width: 5132,
          height: 168,
        },
      ],
