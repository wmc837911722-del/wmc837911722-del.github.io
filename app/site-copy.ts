  ...
  en: {
    ...
    partners: {
      ...
      tiles: [
        ...
        { id: "private-slot-01", kind: "placeholder", eyebrow: "VISUAL PLACEHOLDER", mark: "VISUAL 01", name: "Visual only · no client/partner endorsement", note: "Visual placeholder only; it does not identify a client, collaboration or public brand and is not an endorsement" },
        { id: "private-slot-02", kind: "placeholder", eyebrow: "VISUAL PLACEHOLDER", mark: "VISUAL 02", name: "Visual only · no client/partner endorsement", note: "Visual placeholder only; it does not identify a client, collaboration or public brand and is not an endorsement" },
        { id: "private-slot-03", kind: "placeholder", eyebrow: "VISUAL PLACEHOLDER", mark: "VISUAL 03", name: "Visual only · no client/partner endorsement", note: "Visual placeholder only; it does not identify a client, collaboration or public brand and is not an endorsement" },
        { id: "private-slot-04", kind: "placeholder", eyebrow: "VISUAL PLACEHOLDER", mark: "VISUAL 04", name: "Visual only · no client/partner endorsement", note: "Visual placeholder only; it does not identify a client, collaboration or public brand and is not an endorsement" },
        { id: "private-slot-05", kind: "placeholder", eyebrow: "VISUAL PLACEHOLDER", mark: "VISUAL 05", name: "Visual only · no client/partner endorsement", note: "Visual placeholder only; it does not identify a client, collaboration or public brand and is not an endorsement" },
