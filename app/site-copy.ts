...
export const siteCopy = {
  zh: {
    ...
    partners: {
      ...
      labelLocal: "合作品牌",
      kicker: "SELECTED / DISCLOSED WITH PERMISSION",
      title: ["合作建立在交付，", "也建立在信任边界。"],
      intro:
        "以下为已确认并获得公开许可的部分合作与产品品牌。当前并未完整展示全部合作记录；其余品牌、客户名称、项目资料与业务数据因保密约定不公开。",
      aria: "部分公开展示的合作与产品品牌",
      pauseMotion: "暂停品牌滚动",
      resumeMotion: "继续品牌滚动",
      tiles: [
        ...
        },
        {
          id: "private-slot-01",
          kind: "placeholder",
          eyebrow: "PRIVATE SLOT / 匿名视觉位",
          mark: "PRIVATE 01",
          name: "匿名品牌展示位",
          note: "视觉占位，不代表具体客户或公开品牌声明",
        },
        {
          id: "private-slot-02",
          kind: "placeholder",
  ...
  en: {
    ...
    partners: {
      ...
      intro: "These are selected collaboration and product brands approved for disclosure. This is not a complete record: other brands, client names, project materials and business data remain undisclosed under confidentiality agreements.",
      aria: "Selected collaboration and product brands approved for public display",
      pauseMotion: "Pause brand wall",
      resumeMotion: "Resume brand wall",
      tiles: [
        ...
        { id: "private-slot-01", kind: "placeholder", eyebrow: "PRIVATE VISUAL SLOT", mark: "PRIVATE 01", name: "Anonymous brand slot", note: "Visual placeholder; does not identify a specific public brand and is not a client claim" },
        { id: "private-slot-02", kind: "placeholder", eyebrow: "PRIVATE VISUAL SLOT", mark: "PRIVATE 02", name: "Anonymous brand slot", note: "Visual placeholder; does not identify a specific public brand and is not a client claim" },
        { id: "private-slot-03", kind: "placeholder", eyebrow: "PRIVATE VISUAL SLOT", mark: "PRIVATE 03", name: "Anonymous brand slot", note: "Visual placeholder; does not identify a specific public brand and is not a client claim" },
        { id: "private-slot-04", kind: "placeholder", eyebrow: "PRIVATE VISUAL SLOT", mark: "PRIVATE 04", name: "Anonymous brand slot", note: "Visual placeholder; does not identify a specific public brand and is not a client claim" },
        { id: "private-slot-05", kind: "placeholder", eyebrow: "PRIVATE VISUAL SLOT", mark: "PRIVATE 05", name: "Anonymous brand slot", note: "Visual placeholder; does not identify a specific public brand and is not a client claim" },
