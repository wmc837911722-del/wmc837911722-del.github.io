...
export const siteCopy = {
  zh: {
    ...
    contact: {
      ...
      emailListLabel: "联系邮箱",
      emailAria: "发送合作邮件到",
      wechatLabel: "WECHAT / 微信",
      wechatTitle: "微信扫码联系",
      wechatNote: "电脑端可直接扫码；手机端可长按保存后在微信识别。显示名为「瑞典 西曼兰」，添加时备注「项目合作」。",
      wechatImageAlt: "风雨的微信二维码，微信显示名为瑞典 西曼兰",
      copyIdle: "复制合作沟通模板",
  ...
  en: {
    ...
    contact: {
      ...
      wechatLabel: "WECHAT / SCAN TO TALK",
      wechatTitle: "Contact me on WeChat",
      wechatNote: "Scan on desktop. On mobile, press and hold to save, then recognize it in WeChat. The display name is “瑞典 西曼兰”.",
      wechatImageAlt: "WeChat QR code for contacting Fengyu; display name 瑞典 西曼兰",
